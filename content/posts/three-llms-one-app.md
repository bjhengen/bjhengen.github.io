...
![llm_combined_chart](assets/llm_combined_chart.png)

*Caption: Comparing response time, processing speed (tokens/sec), and my determiniation of answer quality (scored 1-10) across cloud, local, and GPU-based LLMs.*
