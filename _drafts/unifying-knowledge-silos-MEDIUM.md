...
*This is Part 4 of my series on Building a Knowledge Management App with Oracle AI Database 26ai. See also: [Part 1: Three LLMs, One App](https://brianhengen.us/posts/three-llms-one-app/) | [Part 2: CLIP Inside Oracle](https://brianhengen.us/posts/clip-inside-oracle-ai-database-26ai-11nov25/) | [Part 3: Vision-Aware RAG](https://brianhengen.us/posts/vision-aware-rag-python-bridge/)*

---

> **TL;DR:** Unified 12 years of scattered notes — 5,178 OneNote pages plus daily markdown journals — into a single AI-searchable knowledge base powered by Oracle AI Database 26ai. The result: I can ask "What did I write about AI in 2021?" and get instant, accurate answers — regardless of where the note originated.
...
**PDF Export** — Already working, but manual and loses metadata

**MCP Server** — Clean abstraction, but additional process to manage
...
> 💡 **Insight:** The debounce timer significantly impacts user experience. Too short (30s) and you're constantly processing partial thoughts. Too long (10min) and users wonder why their notes aren't syncing. 3 minutes is the sweet spot for my workflow.
...
**📊 5,925 Total Documents**

**📊 13,279 Vector Chunks**
...
*Originally published at [brianhengen.us](https://brianhengen.us/posts/unifying-knowledge-silos-onenote-markdown/)*
